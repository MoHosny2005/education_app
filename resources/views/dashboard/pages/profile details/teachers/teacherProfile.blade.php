            ...
            <div class="profile-wrapper mb-30">
              <div class="profile-cover">
                @if(Auth::guard('teach')->user()->cover_img)
                 <img src="{{asset('storage/images/teachers/' . $teacher_data->cover_img )}}" alt="cover-image          " />
                @else
                 <img src="{{asset('dashboard')}}/images/profile/profile-cover.jpg" alt="cover-image" />
                @endif
                <div class="update-image">
                  <a href="{{route('UpdateTeachercoverPhoto')}}" class="text-black d-flex align-items-center gap-1 justify-content-center ">
                  <i class="lni lni-camera"></i> <p>Edit Cover Photo</p>
                 </a>
                </div>
              </div>
              <div class="d-md-flex">
                <div class="profile-photo">
                  <div class="image">
                    <img src="{{asset('storage/images/teachers/' . $teacher_data->img )}}" alt="profile" />
                    <div class="update-image">
                      <a href="UpdateTeacherProfilePhoto" class=" text-black ">
                  ...
                  <div class="profile-meta pt-25">
                    <h5 class=" text-bold  mb-10">{{ $teacher_data->name }}</h5>
                    <p class=" text-sm ">{{ $teacher_data->subject->name . " Teacher" }}  </p>
              ...
              <div class="profile-info">
                ...
                <ul class="d-flex flex-column gap-2  mt-4">
                  <li>
                     <p class=" text-sm ">{{ $teacher_data->email }}  </p>
                  </li>
                  <li>
                    <p class=" text-sm ">{{ $teacher_data->age . " Years" }}  </p>
                  </li>
                  <li>
                     <p class=" text-sm ">{{ "Joined At: " . $teacher_data->created_at  }}  </p>
                  </li>

                </ul>

                <div>
                    <a href="{{ route('teacherProfile.edit' , $teacher_data->id ) }}" class="btn btn-primary">Update Your Profile</a>
                </div>
