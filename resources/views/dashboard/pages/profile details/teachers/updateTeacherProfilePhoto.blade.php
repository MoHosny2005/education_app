...
<div class="card-style mb-30">
    ...
    <form action="{{route('updatingTeacherProfilePhoto' , Auth::guard('teach')->user()->id)}}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="d-flex flex-column align-items-center py-4">
            ...
            <div class="position-relative d-inline-block">
                ...
                <img
                    id="teacherPreview"
                    src="{{ asset('storage/images/teachers/' . Auth::guard('teach')->user()->img) }}"
