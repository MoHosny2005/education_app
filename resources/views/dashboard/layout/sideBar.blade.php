...
<!-- Mirrored from demo.plainadmin.com/modals by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 06 Oct 2025 10:09:13 GMT -->
...
<body>
  ...
  <aside class="sidebar-nav-wrapper">
    ...
    <nav class="sidebar-nav">
      <ul>
        <li class="nav-item ">
          <a href="/dash/index" class="collapsed" >
            <span class="icon">
        ...
        {{-- years li --}}
         <li class="nav-item ">
          <a href="/dash/year" class="collapsed d-flex justify-content-center align-items-center">
            <span class="icon  ">
          ...
          <li class="nav-item ">
          <a href="subject" class="collapsed d-flex justify-content-center align-items-center">
            <span class="icon  ">
               <i class="lni lni-agenda"></i>
            </span>
        ...
        <li class="nav-item ">
          <a href="/dash/manager" class="collapsed d-flex justify-content-center align-items-center">
            <span class="icon  ">
               <i class="lni lni-agenda"></i>
            </span>
         ...
         <li class="nav-item ">
          <a href="/dash/teacher" class="collapsed d-flex justify-content-center align-items-center">
            <span class="icon  ">
               <i class="lni lni-agenda"></i>
            </span>
    ...
    <li class="nav-item ">
        ...
        <li class="nav-item nav-item-has-children">
          <a href="#0" class="" data-bs-toggle="collapse" data-bs-target="#ddmenu_4" aria-controls="ddmenu_4"
            aria-expanded="false" aria-label="Toggle navigation">
            <span class="icon">
              <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
          ...
          <ul id="ddmenu_4" class="collapse show dropdown-nav">
            ...
            <li>
              <a href="modals.html" class="active">
                <span class="text">
